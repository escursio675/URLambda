    ...
    return(
        ...
        <div>
            ...
            <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center px-6 py-12">
                ...
                <div className=" w-full max-w-3xl bg-black/1 
                    border border-white/10 backdrop-blur-2xl rounded-2xl p-10 shadow-xl">
                            ...
                            urls.length === 0 ? (
                                ...
                                urls.map((url) => (
                                    ...
                                    <div
                                        ...
                                        <p className="break-all text-xl mb-5 text-xl">
                                            {url.longUrl}
                                        </p>
                                        ...
                                        <div className="flex items-center gap-3 mt-5">
                                            ...
                                            <button
                                                ...
                                                className="
                                                    px-4 py-2 border border-gray-300 dark:border-white/20 
                                                    dark:text-red-400 dark:hover:bg-white/5 rounded-lg 
                                                    text-center text-sm font-semibold text-red-400 transition-colors
                                                "
                                            >
                                                Delete URL Entry
                                            </button>
